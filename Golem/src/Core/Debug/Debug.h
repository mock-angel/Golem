...
#define GOLEM_PROFILE 0
	...
	#define GOLEM_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Golem::TimekeeperUtils::CleanupOutputString(name, "__cdecl ");\
	...
	#define GOLEM_PROFILE_FUNCTION() GOLEM_PROFILE_SCOPE(HZ_FUNC_SIG)
#else
